abstract class _Result<T, E extends Error> {
	...
	chain(ok: (value: T) => Result<unknown>, err?: (error: E) => Result<unknown>): Result<unknown> {
...
export namespace Result {
	...
	>(
		...
		[OkType<R0>, OkType<R1>, OkType<R2>, OkType<R3>, OkType<R4>, OkType<R5>, OkType<R6>],
	...
	>;
	export function all<R0 extends U, R1 extends U, R2 extends U, R3 extends U, R4 extends U>(
		obj: [R0, R1, R2, R3, R4]
	): Result<
	...
	export function all<R0 extends U, R1 extends U, R2 extends U, R3 extends U>(
		obj: [R0, R1, R2, R3]
	): Result<[OkType<R0>, OkType<R1>, OkType<R2>, OkType<R3>], ErrType<R0 | R1 | R2 | R3>>;
